...
namespace SiteCalculations.Models
{
    public class KindergartenModel: IBaseBuilding
    {
        ...
        public KindergartenModel(CityModel city, string[] parameters, BuildingBorderModel plot, ParkingModel exParking, Point3d midPoint)
        {
            ...
            TotalParkingReq = city.Parking.CalculateParking(Name, new double[] { 0, 0, 0, 0, 0, 0, 0, NumberOfStudents, 0, 0, 0 });
